public class Weapon {
	...
	public static Weapon generateWeapon() {
        ...
        switch(randomWeapon) {
			case 0:
				return new Weapon("Shotgun", 100, 50);
			case 1:
				return new Weapon("Submachine Gun", 25, 73);
			case 2:
				return new Weapon("Assault Rifle", 30, 80);
			case 3:
				return new Weapon("Pistol", 20, 90);
			case 4:
				return new Weapon("Axe", 30, 80);
			case 5:
				return new Weapon("Crowbar", 20, 70);
			case 6:
				return new Weapon("Frying Pan", 15, 95);
        }
